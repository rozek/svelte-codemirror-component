(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, (function () {
        var current = global.CodeMirrorComponent;
        var exports = global.CodeMirrorComponent = factory();
        exports.noConflict = function () { global.CodeMirrorComponent = current; return exports; };
    })());
    ...
    var css_248z = ".my .CodeMirror{height:100%}";
    styleInject(css_248z,{"insertAt":"top"});

    /* src/svelte-codemirror-component.svelte generated by Svelte v3.46.4 */
    ...
    function instance($$self, $$props, $$invalidate) {
    	const omit_props_names = [
    		"Editor","Value","Options","readonly","Mode","LintOptions","withLineNumbers","withLineWrapping","Indentation","TabSize","indentWithTabs","closeBrackets","closeTags"
    	];
    	...
    	let { Mode = 'js' } = $$props;
    	let { LintOptions = null } = $$props;
    	let { withLineNumbers = true } = $$props;
    	let { withLineWrapping = false } = $$props;
    	let { Indentation = 2 } = $$props;
    	let { TabSize = 2 } = $$props;
    	let { indentWithTabs = false } = $$props;
    	let { closeBrackets = false } = $$props;
    	let { closeTags = false } = $$props;
    	...
    	function createEditor(Options) {
    		if (Editor != null) {
    			$$invalidate(0, EditorElement.innerHTML = '', EditorElement);
    		}

    		$$invalidate(2, Editor = CodeMirror(EditorElement, Options));

    		Editor.on('change', Event => {
    			$$invalidate(3, Value = Editor.getValue());
    	...
    	$$self.$$set = $$new_props => {
    		...
    		if ('Editor' in $$new_props) $$invalidate(2, Editor = $$new_props.Editor);
    		...
    		if ('LintOptions' in $$new_props) $$invalidate(7, LintOptions = $$new_props.LintOptions);
    		if ('withLineNumbers' in $$new_props) $$invalidate(8, withLineNumbers = $$new_props.withLineNumbers);
    		if ('withLineWrapping' in $$new_props) $$invalidate(9, withLineWrapping = $$new_props.withLineWrapping);
    		if ('Indentation' in $$new_props) $$invalidate(10, Indentation = $$new_props.Indentation);
    		if ('TabSize' in $$new_props) $$invalidate(11, TabSize = $$new_props.TabSize);
    		if ('indentWithTabs' in $$new_props) $$invalidate(12, indentWithTabs = $$new_props.indentWithTabs);
    		if ('closeBrackets' in $$new_props) $$invalidate(13, closeBrackets = $$new_props.closeBrackets);
    		if ('closeTags' in $$new_props) $$invalidate(14, closeTags = $$new_props.closeTags);
    	};
    ...
    class Svelte_codemirror_component extends SvelteComponent {
    	constructor(options) {
    		super();
    ...
    return Svelte_codemirror_component;

}));
//# sourceMappingURL=svelte-codemirror-component.js.map
